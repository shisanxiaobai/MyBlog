<template>
  <div>
    <el-table :data="CategoryList" border style="width: 100%">
      ...
      <el-table-column label="更新日期" align="center" width="220">
      ...
      <el-table-column prop="desc" label="项目描述" align="center" width="300">
        <template slot-scope="scope">
          <span>{{ scope.row.desc }}</span>
        </template>
      </el-table-column>
      <el-table-column prop="img" label="图片" align="center" width="300">
        <template slot-scope="scope">
      ...
      <el-table-column fixed="right" align="center" label="操作" width=200px>
        <template slot-scope="scope">
          <el-button @click="Edit(scope.row.ID)" type="primary" plain size="small">编辑</el-button>
